        ...
        while len(w) > 0:
            ...
            for c in alphabet:
                ...
                for y in p:
                    ...
                    # if X ? Y is nonempty and Y \ X is nonempty replace Y in P by the two sets X ? Y and Y \ X
...
def main():
    # gr = Worker(start, grammer)

    gr = Worker('start', "start = 'TYPE 'id '_=_' ( simpletype | arrtype | rectype | settype | pntrtype ) '_;' \n"
    ...
    dot_graph = nx.nx_pydot.read_dot("24")
